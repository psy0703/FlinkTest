...
public class HBaseWrite {
    //表名
    public static final String HBASE_TABLE_NAME = "headline";
    // 列族
    static final byte[] COLUMNfAMILY =
            "info_sink".getBytes(ConfigConstants.DEFAULT_CHARSET);
    //列名
    static final byte[] COLUMN =
            "bar_sink".getBytes(ConfigConstants.DEFAULT_CHARSET);
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.fromElements(WORDS).flatMap(new FlatMapFunction<String,
