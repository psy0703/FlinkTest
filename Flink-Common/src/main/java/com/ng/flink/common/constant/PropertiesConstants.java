package com.ng.flink.common.constant;
...
public class PropertiesConstants {
    ...
    public static final String DEFAULT_KAFKA_BROKERS = "psy831:9092," +
            "psy832:9092,psy833:9092";
    public static final String KAFKA_ZOOKEEPER_CONNECT = "kafka.zookeeper.connect";
    public static final String DEFAULT_KAFKA_ZOOKEEPER_CONNECT = "psy831" +
            ":2181,psy832:2181,psy833:2181";
    public static final String KAFKA_GROUP_ID = "kafka.group.id";
    public static final String DEFAULT_KAFKA_GROUP_ID = "headline";
